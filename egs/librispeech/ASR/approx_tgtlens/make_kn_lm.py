...
class NgramCounts:
    ...
    def __init__(self, ngram_order, bos_symbol="<s>", eos_symbol="</s>", bpe=None):
    ...
    def add_raw_counts_from_line(self, line):
        if line == "":
            ...
            words = [self.bos_symbol] + self.split(line) + [self.eos_symbol]
...
if __name__ == "__main__":
    ngram_counts = NgramCounts(args.ngram_order, bpe=args.bpe)
