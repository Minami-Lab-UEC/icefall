...
./cift1/offline-decode_cmd2.sh \
    "32" "4" "4 8 12 16 20" 0 $exp_dir/paper5_ep$epoch $exp_dir $setup $epoch "$max_sym_range" &
./cift1/offline-decode_cmd2.sh \
    "32" "4" "5 9 13 17 21" 1 $exp_dir/paper5_ep$epoch $exp_dir $setup $epoch "$max_sym_range" &
./cift1/offline-decode_cmd2.sh \
    "32" "4" "6 10 14 18 22" 2 $exp_dir/paper5_ep$epoch $exp_dir $setup $epoch "$max_sym_range" &
./cift1/offline-decode_cmd2.sh \
    "32" "4" "7 11 15 19 23" 3 $exp_dir/paper5_ep$epoch $exp_dir $setup $epoch "$max_sym_range" &
wait
