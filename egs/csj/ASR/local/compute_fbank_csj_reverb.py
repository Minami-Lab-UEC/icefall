...
def make_cutset_blueprints(
    ...
    for i in range(1, 4):
        ...
        cut_sets.append((f"eval{i}", rever(cut_set)))
    ...
    cut_set = cut_set.trim_to_supervisions(keep_overlapping=False)
    cut_sets.append(("excluded", rever(cut_set)))
    ...
    cut_set = cut_set.trim_to_supervisions(keep_overlapping=False)
    cut_sets.append(("valid", rever(cut_set)))
    ...
    train_set = rever(train_set) + rever(train_set).perturb_speed(0.9) + rever(train_set).perturb_speed(1.1)
