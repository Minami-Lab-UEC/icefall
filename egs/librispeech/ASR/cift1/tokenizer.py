...
class Tokenizer:
    ...
    @staticmethod
    def Load(lang_dir: Path, lang_type="", oov="<unk>", **kwargs):
        ...
        if lang_type == "bpe":
            ...
            tokenizer.text2word = lambda x: x.split()
        elif lang_type == "char":
            tokenizer = CharTokenizer(lang_dir, oov=oov, **kwargs)
        else:
...
# class SPMBPETokenizer(Tokenizer, spm.SentencePieceProcessor):
